...
var ThemeState = class ThemeState2 {
  constructor(themeOptionService, themeService) {
  ...
  static {
    this.\u0275fac = function ThemeState_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || ThemeState2)(\u0275\u0275inject(ThemeOptionService), \u0275\u0275inject(ThemeService));
    };
  }
  static {
...
var _c02 = ["newsletterModal"];
function NewsletterModalComponent_ng_template_0_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function NewsletterModalComponent_ng_template_0_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function NewsletterModalComponent_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngSubmit", function NewsletterModalComponent_ng_template_0_Template_form_ngSubmit_10_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275template(14, NewsletterModalComponent_ng_template_0_Conditional_14_Template, 3, 3, "div", 9)(15, NewsletterModalComponent_ng_template_0_Conditional_15_Template, 3, 3, "div", 9);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(13, 12, "enter_email_address"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(19, 14, "subscribe"));
    \u0275\u0275advance(3);
...
var NewsletterModalComponent = class _NewsletterModalComponent {
  constructor(store, modalService, themeOptionService, platformId, formBuilder) {
    this.store = store;
    ...
    this.modalOpen = true;
    this.isSubmit = false;
    this.storageURL = environment2.storageURL;
  ...
  static {
    this.\u0275fac = function NewsletterModalComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NewsletterModalComponent)(\u0275\u0275directiveInject(Store), \u0275\u0275directiveInject(NgbModal), \u0275\u0275directiveInject(ThemeOptionService), \u0275\u0275directiveInject(PLATFORM_ID), \u0275\u0275directiveInject(FormBuilder));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewsletterModalComponent, selectors: [["app-newsletter-modal"]], viewQuery: function NewsletterModalComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c02, 7);
      }
      if (rf & 2) {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 0, consts: [["newsletterModal", ""], [1, "modal-body"], [1, "modal-content", "open"], [1, "d-flex"], [1, "right-content", "w-lg-50", "w-100"], [1, "auth-title"], ["id", "mc-embedded-subscribe-form", "name", "mc-embedded-subscribe-form", 1, "auth-form", "needs-validation", 3, "ngSubmit", "formGroup"], [1, "form-group", "mx-sm-3", "text-center", "mb-0"], ["type", "email", "formControlName", "email", 1, "form-control", "mb-3", "input-padding", 3, "placeholder"], [1, "invalid-feedback"], [3, "id", "spinner"], [1, "d-sm-inline-block", "d-none"], [1, "left-img", "w-lg-50", "d-lg-block", "d-none"], [3, "src"]], template: function NewsletterModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, NewsletterModalComponent_ng_template_0_Template, 22, 16, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      }
    }, dependencies: [TranslateModule, TranslatePipe, FormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, ReactiveFormsModule, FormGroupDirective, FormControlName, ButtonComponent] });
  }
};
__decorate([
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewsletterModalComponent, { className: "NewsletterModalComponent" });
})();
...
//# sourceMappingURL=chunk-TM2AEMKX.js.map
